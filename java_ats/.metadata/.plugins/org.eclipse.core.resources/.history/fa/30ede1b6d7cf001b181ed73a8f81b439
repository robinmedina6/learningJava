...
public class Ventana extends JFrame {
	...
	private void colocarAreaDeTexto() {
		...
		scroll.setBounds(30,30,200,300);
		panel1.add(scroll);
	...
	private void colocarCajaEventoTexto() {
		...
		cajaTextoEvento.setBounds(20,5,100,20);
	...
	private void eventoOyenteDeTeclado() {
		cajaTextoEvento.addKeyListener(new KeyListener() {
			
			@Override
			public void keyTyped(KeyEvent e) {
				areaTexto.append(" KTyped: "+e.getKeyChar()+"\n");
			}
			
			@Override
			public void keyReleased(KeyEvent e) {
				areaTexto.append(" KReleased: "+e.getKeyChar()+"\n");
			}

			@Override
			public void keyPressed(KeyEvent e) {
				areaTexto.append(" KPresed: "+e.getKeyChar()+"\n");
			}
